...
export default {
  name: 'Blog',
  components: { BlogCard, BaseModal, BaseLoader, BaseAlert, BaseSuccess },
  data() {
    return {
      usuario: null,
  ...
  methods: {
    async crearPublicacion() {
      ...
      this.mensajeSuccess = '¡Publicación creada exitosamente!';
    ...
    eliminarPublicacion(idPublicacion) {
      ...
      this.guardarPublicaciones();
      this.mensajeSuccess = 'Publicación eliminada correctamente.';
      setTimeout(() => { this.mensajeSuccess = ''; }, 4000);
    },
    ...
    actualizarPublicacion() {
      ...
      if (index !== -1) {
        ...
        this.guardarPublicaciones();
        this.mensajeSuccess = 'Publicación actualizada correctamente.';
        setTimeout(() => { this.mensajeSuccess = ''; }, 4000);
      }
